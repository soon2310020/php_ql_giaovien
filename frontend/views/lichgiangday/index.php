        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                ...
                <div class="modal-body row"  style="padding: 10px;">
                    ...
                    <div class="col-md-2">Thời gian(<font color="red">*</font>)</div>
                    <div class="col-md-3">
                        <select ng-model="itemFix.thoiGian" class="form-control" disabled >
                            <option value=""  disabled style="display:none">--Lựa chọn--</option>
                            <option ng-repeat="(value,item) in thu" ng-value="{{value}}">{{item}}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2">Số tiết(<font color="red">*</font>)</div>
                    <div class="col-md-3">
                        <input class="form-control" type="text" placeholder="Số tiết..." ng-model="itemFix.soTiet" maxlength="50" disabled>
                    </div>
                ...
                <div class="modal-body row"  style="padding: 10px;">
                    ...
                    <div class="col-md-2">Địa điểm(<font color="red">*</font> )</div>
                    <div class="col-md-3">
                        <input class="form-control" type="text" placeholder="Địa điểm..." ng-model="itemFix.diaDiem" maxlength="50" disabled >
                    </div>
                    <div class="col-md-1"></div>
                    <div class="col-md-2">Ghi chú(<font color="red">*</font>)</div>
                    <div class="col-md-3">
                        <input class="form-control" type="text" id="file" ng-model="itemFix.ghiChu"  disabled>
                    </div>
