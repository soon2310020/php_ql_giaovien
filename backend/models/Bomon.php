...
class Bomon extends Model
{
    ...
    public function ThemBoMon($maBoMon, $tenBoMon, $maKhoa, $moTa)
	  {
        ...
        $sql = "INSERT INTO bomon VALUES($maBoMon, $maKhoa,'$tenBoMon', '$moTa', '$now', '$now')";
        //return $sql;
    ...
    public function SuaBoMon($maBoMon, $tenBoMon, $maKhoa, $moTa)
	  {
        $now = date("Y-m-d H:i:s");
        $sql = "UPDATE bomon SET tenBoMon = '$tenBoMon',moTa = '$moTa',maKhoa = $maKhoa, updated_at='$now' WHERE maBoMon = $maBoMon";
